...
const Chaptervedio = () => {
    ...
    const changeVideo = (url, id, title) => {
                                    ...
                                    <>
                                        {
                                            (index == 0) ?
                                                <div className="col-lg-3" key={index}>
                                                    <Link to="javascript:;" onLoad={() => changeVideo(val.url, val.id, val.title)} onClick={() => changeVideo(val.url, val.id, val.title)} className="video_inner">
                                                ...
                                                (val.url_type!=3)?
                                                <div className="col-lg-3" key={index}>
                                                    <Link to="javascript:;" onClick={() => changeVideo(val.url, val.id, val.title)} className="video_inner">
                                                        <div className="video_list text-center">
                                                        <img src={val.image} alt='vedio' width="100%"  />
                                                            <img src={require("../img/play.png")} alt='vedio' className="play" />
                                                            {
