...
const VideoDetailLong = () => {
    ...
    return (
        ...
        description={singlevideo?.data?.imageurl} 
        keyword={singlevideo?.data?.title}
        author="Khulasa News"
        image={singlevideo?.data?.imageurl}
        URL={`${Web_Url}/detail/${singlevideo?.data?.slug}`}
        type=""
        name=""
      /> */}
            ...
            <div className="main-container long-video video-detail">
                <div className="row">
                    ...
                    <div className="d-flex justify-content-center ">
                        <div className="long-youtube-vid">
                            {singlevideo?.data?.videotype === "YOUTUBE" ?

                                <iframe class="videoIFrame" src={singlevideo?.data?.youtubeurl} frameborder="0" allowfullscreen></iframe>
